...
const HealthCountdown = () => {
  ...
  const achievements = [
    ...
    {
      id: 3,
      name: "Metformin Master",
      desc: "First week on medication",
      icon: "💊",
      unlocked: false,
      day: 7,
    },
    ...
    {
      id: 7,
      name: "10 Pound Legend",
      desc: "Double digits down",
      icon: "🏆",
      unlocked: false,
      day: 14,
    },
    {
      id: 8,
      name: "Month One Champion",
      desc: "30 days completed",
      icon: "👑",
      unlocked: false,
      day: 30,
    },
    ...
    {
      id: 10,
      name: "20 Pound Destroyer",
      desc: "20 lbs obliterated",
      icon: "💥",
      unlocked: false,
      day: 45,
    },
  ...
  const CircularProgress = ({
    ...
    return (
      <div style={{ position: "relative", width: size, height: size }}>
        ...
        >
          <div style={{ fontSize: size / 4, fontWeight: "800", color: "#fff" }}>
            {label}
          </div>
          <div style={{ fontSize: size / 10, color: "#aaa", marginTop: 4 }}>
            {sublabel}
          </div>
        </div>
      </div>
  ...
  const styles = {
    ...
    achievement: (unlocked) => ({
      ...
      padding: isMobile ? "12px 10px" : "20px 15px",
      textAlign: "center",
      border: unlocked
        ? "2px solid #4ade80"
    ...
    <div style={styles.container}>
      ...
      <div style={styles.header}>
        ...
        <p style={{ color: "#a0aec0", fontSize: "1.1rem" }}>
          Day{" "}
          <span
            style={{ color: "#4ade80", fontWeight: "700", fontSize: "1.3rem" }}
          >
            {daysElapsed + 1}
          </span>{" "}
            ...
            <div style={styles.statsGrid}>
              <div style={styles.statCard}>
                ...
                <CircularProgress
                  ...
                  max={35}
                  size={isMobile ? 130 : isTablet ? 150 : 180}
              ...
              {[
                ...
                >
                  {isMobile ? (
                    ...
                    <>
                      <div style={{ fontSize: isTablet ? "1.5rem" : "2rem" }}>
                        {item.emoji}
                      </div>
                      <div
                        style={{
            ...
            {[
              {
                ...
                color: "#f5576c",
                items: [
                  "5-10 lbs water weight gone",
                  "Blood sugar dropping fast",
                  "Cravings breaking",
              ...
              <div
                key={i}
                style={{ display: "flex", gap: isMobile ? "12px" : "20px" }}
              >
                <div
                  style={{
                    display: "flex",
                  ...
                  <div
                    style={{
                      ...
                      border: `${isMobile ? "2px" : "3px"} solid ${
                        phase.status === "active" ? phase.color : "transparent"
                      }`,
                      boxShadow:
                        phase.status === "active"
                          ? `0 0 ${isMobile ? "10px" : "20px"} ${phase.color}`
                          : "none",
                      display: "flex",
                      alignItems: "center",
                      justifyContent: "center",
                  ...
                  {i < 3 && (
                    <div
                      style={{
                        ...
                        flex: 1,
                        background:
                          phase.status === "complete" ? "#4ade80" : "#333",
      ...
      >
        ...
        <p style={{ color: "#888", fontSize: isMobile ? "0.85rem" : "1rem" }}>
          You're not on a diet. You're on a{" "}
          <span style={{ color: "#4ade80", fontWeight: "700" }}>MISSION</span>.
        </p>
      </div>
    </div>
  );
