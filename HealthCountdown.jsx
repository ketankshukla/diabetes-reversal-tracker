...
const HealthCountdown = () => {
  ...
  const achievements = [
    { id: 1, name: "Day One Warrior", desc: "Started the journey", icon: "🎯", day: 1 },
    { id: 2, name: "Sugar Free", desc: "24 hours no sugar", icon: "🍬", day: 1 },
    { id: 3, name: "Metformin Master", desc: "First week on medication", icon: "💊", day: 7 },
    { id: 4, name: "Fat Burner", desc: "Body entered ketosis", icon: "🔥", day: 3 },
    { id: 5, name: "5 Pound Club", desc: "Lost first 5 lbs", icon: "⚖️", day: 5 },
    { id: 6, name: "Two Week Titan", desc: "14 days strong", icon: "💪", day: 14 },
    { id: 7, name: "10 Pound Legend", desc: "Double digits down", icon: "🏆", day: 14 },
    { id: 8, name: "Month One Champion", desc: "30 days completed", icon: "👑", day: 30 },
    { id: 9, name: "Halfway Hero", desc: "41 days - halfway there!", icon: "🦸", day: 41 },
    { id: 10, name: "20 Pound Destroyer", desc: "20 lbs obliterated", icon: "💥", day: 45 },
    { id: 11, name: "Two Month Warrior", desc: "60 days of discipline", icon: "⚔️", day: 60 },
    { id: 12, name: "Victory Lap", desc: "Lab test day arrived!", icon: "🎉", day: 82 },
  ];
      ...
      {activeTab === "countdown" && (
        <>
          ...
          <div style={styles.card}>
            ...
            <div style={styles.progressBar}>
              <div style={styles.progressFill(progress, "linear-gradient(90deg, #00d4aa, #4facfe)")} />
            </div>
          </div>
        </>
      )}
