    ...
    >
      ...
      <div style={{ padding: "20px", maxWidth: "600px", margin: "0 auto" }}>
        ...
        >
          ...
          <h2
            style={{ color: "#fff", margin: "0 0 20px 0", fontSize: "1.4rem" }}
          >
        ...
        >
          ...
          >
            ...
            <div
              style={{ color: "#a78bfa", fontSize: "1.1rem", marginTop: "5px" }}
            >
        ...
        >
          ...
          <div style={{ display: "grid", gap: "12px" }}>
            ...
            >
              ...
              <div style={{ color: "#94a3b8", fontSize: "0.85rem" }}>
                <strong>First:</strong> Reduce beef (skip beef, add +1 chicken
                serving)
                <br />
                <strong>Then:</strong> Reduce total chicken servings if still
                needed
              </div>
            </div>
            ...
            >
              ...
              <div style={{ color: "#94a3b8", fontSize: "0.85rem" }}>
                Add steam-in-bag veggies (no sauce) or big salad with olive oil
                + pepper
              </div>
            </div>
          </div>
        ...
        >
          ...
          <div
            style={{
              background: "linear-gradient(135deg, #f59e0b20 0%, #1e293b 100%)",
              padding: "20px",
              borderRadius: "12px",
              marginBottom: "15px",
          ...
          >
            <div
              style={{ color: "#e2e8f0", fontWeight: 700, marginBottom: "8px" }}
            >
            ...
            >
              Only separate if you want beef very well done, or chicken pieces
              are much thicker/colder than usual.
            </div>
            <div style={{ color: "#94a3b8", fontSize: "0.85rem" }}>
              <strong>If separating:</strong> Beef 20–25 sec, Chicken 25–35 sec
              (each covered)
            </div>
          </div>
        </div>
