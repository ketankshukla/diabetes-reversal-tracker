...
export default function LabTestsGuide() {
  ...
  const tests = [
    {
      ...
      description:
        "The Hemoglobin A1c test measures your average blood sugar levels over the past 2-3 months. It shows how well your diabetes is being controlled and whether your treatment plan is working.",
      whyYouNeedIt: [
      ...
      whenToTake:
        "Every 3 months while A1C is above 7%. Once stabilized, can reduce to every 6 months.",
      ...
      markers: [
        ...
        },
        {
          ...
          description:
            "Converts A1c to an average blood sugar number in mg/dL for easier understanding",
          yourValue: "283 mg/dL",
    ...
    {
      id: "fructosamine",
      name: "Fructosamine (Glycated Serum Protein)",
      searchTerm: "fructosamine",
      price: 31.95,
      icon: Zap,
      color: "cyan",
      frequency: "Every 3 months",
      nextDue: "April 2026",
      category: "Short-Term Glucose Control",
      isNew: true,
      description:
        "Fructosamine measures glycated serum proteins, reflecting your average blood sugar over the past 2-3 WEEKS (vs A1C's 2-3 months). This gives you a faster snapshot of how your dietary changes are working.",
      whyYouNeedIt: [
        "Your kidney function (eGFR 63) can affect A1C accuracy — Fructosamine is NOT affected by kidney function",
        "Shows blood sugar control over 2-3 WEEKS vs A1C's 2-3 months",
        "You'll see improvement from your zero-carb diet FASTER than waiting for A1C",
        "Provides a second data point to verify your progress",
        "Especially valuable during rapid dietary changes like yours",
      ],
      whenToTake:
        "Every 3 months alongside A1C. Particularly useful when making major dietary changes.",
      preparation: "No fasting required. Can be taken any time of day.",
      specialNote:
        "Since your eGFR is 63 (borderline CKD), A1C can sometimes be less accurate. Fructosamine provides a kidney-independent measurement of glucose control.",
      markers: [
        {
          name: "Fructosamine",
          description:
            "Measures glycated serum proteins — reflects 2-3 week average blood sugar",
          yourValue: "Not yet tested",
          normalRange: "200-285 µmol/L",
          diabeticTarget: "<300 µmol/L",
          status: "unknown",
        },
      ],
    },
    {
      ...
      description:
        "A comprehensive blood test that evaluates kidney function, liver function, electrolyte balance, and blood sugar. Essential for monitoring how your body is handling diabetes and Metformin.",
      whyYouNeedIt: [
      ...
      whenToTake:
        "Every 3 months with your A1C test. Critical while kidney function is borderline.",
      preparation:
        "Fasting for 10-12 hours required for accurate glucose reading.",
      markers: [
        {
          name: "Glucose (Fasting)",
          description:
            "Blood sugar level after fasting — shows if liver is overproducing glucose",
          yourValue: "184 mg/dL",
        ...
        },
        {
          name: "Creatinine",
          description:
            "Waste product filtered by kidneys — elevated means kidneys are struggling",
        ...
        },
        {
          ...
          description:
            "Measures how well kidneys filter blood — the key kidney health number",
          yourValue: "63 mL/min",
        ...
        },
        {
          ...
          description:
            "Another kidney waste product — helps confirm kidney function status",
          yourValue: "11 mg/dL",
        ...
        },
        {
          name: "Potassium",
          description:
            "Critical electrolyte for heart rhythm — too high can be dangerous",
        ...
        },
        {
          name: "Total Protein",
          description:
            "Measures albumin and globulin — indicators of nutrition and liver function",
          yourValue: "7.0 g/dL",
        ...
        },
        {
          name: "Albumin",
          description:
            "Protein made by liver — low levels indicate liver or kidney problems",
          yourValue: "4.2 g/dL",
        ...
        },
        {
          name: "Globulin",
          description:
            "Proteins including antibodies — part of immune function",
          yourValue: "2.8 g/dL",
        ...
        },
        {
          ...
          description:
            "Ratio of two protein types — abnormal may indicate disease",
          yourValue: "1.5",
          normalRange: "1.1-2.5",
        ...
        },
        {
          ...
          description:
            "Waste product from red blood cell breakdown — elevated indicates liver issues",
          yourValue: "0.8 mg/dL",
        ...
        },
        {
          ...
          description:
            "Enzyme found in liver and bones — elevated may indicate liver or bone disease",
          yourValue: "65 U/L",
        ...
        },
        {
          ...
          description:
            "Liver enzyme — elevated indicates liver damage or disease",
          yourValue: "17 U/L",
        ...
        },
        {
          ...
          description:
            "Primary liver enzyme — most specific indicator of liver cell damage",
          yourValue: "16 U/L",
    ...
    },
    {
      ...
      description:
        "This urine test detects tiny amounts of protein (albumin) leaking into your urine — an early warning sign of diabetic kidney disease, often before eGFR drops significantly.",
      whyYouNeedIt: [
      ...
      whenToTake:
        "Every 3-6 months for diabetics with borderline kidney function. This is the test most often MISSED — you must specifically request it.",
      preparation:
        "No fasting required. Random urine sample (no 24-hour collection needed).",
      markers: [
        {
          name: "Microalbumin (Urine)",
          description:
            "Tiny amounts of albumin protein in urine — healthy kidneys don't leak protein",
          yourValue: "Not yet tested",
          normalRange: "<30 mg/L",
        ...
        },
        {
          ...
          description:
            "Used to calculate the albumin-to-creatinine ratio for accuracy",
          yourValue: "Not yet tested",
          normalRange: "Varies",
        ...
        },
        {
          ...
          description:
            "The key number — adjusts for urine concentration to give accurate protein measurement",
          yourValue: "Not yet tested",
          normalRange: "<30 mg/g",
    ...
    },
    {
      ...
      description:
        "Measures cholesterol and triglycerides to assess your risk of heart disease and stroke. Diabetics have 2-4x higher risk of heart disease, making this essential.",
      whyYouNeedIt: [
      ...
      whenToTake:
        "Every 6-12 months for diabetics. Get baseline now, then recheck after 3-6 months of diet changes.",
      preparation:
        "Fasting for 9-12 hours required for accurate triglyceride reading.",
      markers: [
        {
          name: "Total Cholesterol",
          description:
            "Sum of all cholesterol types — gives overall picture but less useful alone",
          yourValue: "Not yet tested",
        ...
        },
        {
          ...
          description:
            "Deposits in artery walls causing blockages — lower is better",
          yourValue: "Not yet tested",
        ...
        },
        {
          name: "Triglycerides",
          description:
            "Fat in blood — often elevated with high blood sugar and poor diet",
          yourValue: "Not yet tested",
        ...
        },
        {
          ...
          description:
            'Total cholesterol minus HDL — all the "bad" cholesterol combined',
          yourValue: "Not yet tested",
    ...
    },
    {
      ...
      description:
        "Measures fasting insulin AND calculates your HOMA-IR score — a direct measurement of how insulin resistant you are. This tells you how hard your pancreas is working.",
      whyYouNeedIt: [
      ...
      whenToTake:
        "Every 6-12 months. Get baseline now, then recheck to see if diet and Metformin are reducing insulin resistance.",
      preparation:
        "Fasting for 10-12 hours required. Take in the morning before eating.",
      markers: [
        {
          name: "Fasting Insulin",
          description:
            "Amount of insulin in blood after fasting — high means your body needs more insulin to control sugar",
          yourValue: "Not yet tested",
        ...
        },
        {
          ...
          description:
            "Blood sugar after fasting — used with insulin to calculate HOMA-IR",
        ...
        },
        {
          name: "HOMA-IR Score",
          description:
            "Calculated insulin resistance score — the lower the better",
          yourValue: "Not yet tested",
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-gradient-to-r from-blue-600 to-blue-800 text-white px-4 py-6">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-blue-100">
            Complete guide for diabetes monitoring at Ulta Lab Tests
          </p>
        </div>
      </div>
      ...
      <div className="max-w-4xl mx-auto px-4 mt-4">
        <div className="bg-gradient-to-r from-cyan-500 to-blue-500 rounded-xl p-4 text-white">
          <div className="flex items-center gap-2 mb-2">
            <Zap size={20} />
            <span className="font-bold">NEW: Fructosamine Test Added!</span>
          </div>
          <p className="text-sm text-cyan-100">
            Because your eGFR is 63, A1C can sometimes be less accurate.
            Fructosamine gives you a kidney-independent measurement and shows
            results from the past 2-3 weeks instead of 2-3 months — perfect for
            tracking your rapid dietary changes!
          </p>
        </div>
      </div>
          ...
          <div className="grid grid-cols-2 gap-4 text-sm">
            <div className="bg-white/20 rounded-lg p-3">
              ...
              <p className="font-medium">
                A1C + Fructosamine + CMP + Microalbumin
              </p>
      ...
      {/* A1C vs Fructosamine Comparison */}
      <div className="max-w-4xl mx-auto px-4 mt-4">
        <div className="bg-white rounded-xl shadow-sm p-4 border border-gray-200">
          <h3 className="font-bold text-gray-900 mb-3 flex items-center gap-2">
            <Clock size={18} className="text-blue-600" />
            A1C vs Fructosamine: Why You Need Both
          </h3>
          <div className="grid md:grid-cols-2 gap-4">
            <div className="bg-red-50 rounded-lg p-3 border border-red-200">
              <p className="font-bold text-red-800">A1C Test</p>
              <ul className="text-sm text-red-700 mt-2 space-y-1">
                <li>
                  • Measures past <strong>2-3 months</strong>
                </li>
                <li>• Gold standard for diabetes</li>
                <li>• Can be affected by kidney disease</li>
                <li>• Slower to show improvement</li>
              </ul>
            </div>
            <div className="bg-cyan-50 rounded-lg p-3 border border-cyan-200">
              <p className="font-bold text-cyan-800">Fructosamine Test</p>
              <ul className="text-sm text-cyan-700 mt-2 space-y-1">
                <li>
                  • Measures past <strong>2-3 weeks</strong>
                </li>
                <li>• NOT affected by kidney function</li>
                <li>• Shows rapid dietary changes faster</li>
                <li>• Great verification alongside A1C</li>
              </ul>
            </div>
          </div>
          <p className="text-sm text-gray-600 mt-3 bg-gray-50 rounded-lg p-2">
            💡 <strong>For you specifically:</strong> With eGFR at 63, having
            both tests gives you more accurate picture of your true glucose
            control.
          </p>
        </div>
      </div>
          ...
          return (
            <div
              ...
              className={`bg-white rounded-xl shadow-sm border overflow-hidden ${
                cart[test.id] ? "border-blue-300" : "border-gray-200"
              } ${"isNew" in test && test.isNew ? "ring-2 ring-cyan-400" : ""}`}
            >
              {/* NEW badge */}
              {"isNew" in test && test.isNew && (
                <div className="bg-gradient-to-r from-cyan-500 to-blue-500 text-white text-xs font-bold px-3 py-1 text-center">
                  ⚡ NEWLY ADDED — RECOMMENDED FOR YOUR KIDNEY SITUATION
                </div>
              )}
              ...
              <div className="p-4">
                ...
                {/* Special Note for tests like Fructosamine */}
                {"specialNote" in test && test.specialNote && (
                ...
                >
                  ...
                  {isExpanded ? "Hide" : "Show"} {test.markers.length} Markers
                  Included
                </button>
              </div>
                    ...
                    {test.markers.map((marker, idx) => (
                      ...
                      >
                        ...
                        <div className="grid grid-cols-3 gap-2 mt-3 text-xs">
                          <div
                            className={`rounded p-2 ${getStatusColor(
                              marker.status
                            )}`}
                          >
        ...
        <div className="bg-blue-50 rounded-xl p-5 mt-4 border border-blue-100">
          ...
          <ol className="space-y-2 text-sm text-blue-800">
            ...
            <li className="flex gap-2">
              ...
              Fast 10-12 hours before your lab visit (for accurate glucose/lipid
              results)
            </li>
            <li className="flex gap-2">
              <span className="w-5 h-5 bg-blue-600 text-white rounded-full flex items-center justify-center text-xs flex-shrink-0">
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <ul className="space-y-1 text-sm text-amber-800">
                <li>
                  • <strong>Fructosamine:</strong> Search
                  &quot;fructosamine&quot; — it&apos;s usually listed as
                  &quot;Fructosamine&quot; or &quot;Glycated Serum Protein&quot;
                </li>
                <li>
                  • <strong>Microalbumin:</strong> Scroll past &quot;24
                  Hour&quot; tests to find &quot;Albumin Random Urine Test with
                  Creatinine&quot; — it&apos;s easier (no 24-hour collection)
                </li>
                <li>
                  • <strong>Fasting:</strong> Don&apos;t eat for 10-12 hours
                  before the blood draw — water is OK
                </li>
                <li>
                  • <strong>Metformin:</strong> Take your Metformin AFTER the
                  blood draw, with your breakfast
                </li>
                <li>
                  • <strong>Schedule:</strong> Book a morning appointment so
                  fasting is easier (just skip breakfast)
                </li>
              </ul>
            </div>
          </div>
