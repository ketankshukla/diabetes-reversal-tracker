...
import { LayoutDashboard, Scale, Pill, Timer, TestTube, Menu, X } from 'lucide-react';
          ...
          <div className="p-4 border-t border-white/10">
            <div className="bg-white/5 rounded-xl p-4">
              <div className="flex justify-between items-center mb-3">
                ...
                <span className="text-lg font-bold text-[#00d4aa]">{currentWeight} lbs</span>
              </div>
              <div className="flex justify-between items-center">
                <span className="text-xs text-gray-500 uppercase tracking-wider">Day</span>
                <span className="text-lg font-bold text-[#4facfe]">{daysElapsed + 1}</span>
              </div>
              <div className="mt-3 pt-3 border-t border-white/10">
                <div className="flex justify-between items-center">
                  <span className="text-xs text-gray-500">Goal</span>
                  <span className="text-sm text-[#fbbf24] font-semibold">160 lbs</span>
                </div>
              </div>
            </div>
          </div>
