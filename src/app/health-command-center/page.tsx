...
export default function HealthCommandCenter() {
  ...
  const daysUntilLabs = Math.ceil(
    (labDate.getTime() - today.getTime()) / (1000 * 60 * 60 * 24)
  );
  ...
  const progressPercent =
    ((startA1C - predictedA1C) / (startA1C - targetA1C)) * 100;
  ...
  const scenarios: Scenario[] = [
    {
      label: "Conservative",
      range: "8.0-8.5%",
      desc: "Still excellent (3+ point drop)",
      color: "#f97316",
    },
    {
      label: "Realistic",
  ...
  const factors: Factor[] = [
    {
      icon: "🥩",
      factor: "~7g carbs/day",
      impact: "Virtually no glucose spikes",
    },
    {
      icon: "⏰",
      factor: "OMAD (23hr fast)",
      impact: "Improved insulin sensitivity",
    },
    {
      icon: "💊",
      factor: "Metformin ER",
      impact: "Reduces liver glucose output",
    },
    { icon: "💧", factor: "Hydration", impact: "Supports kidney function" },
    {
      icon: "📅",
      factor: "3 months",
      impact: "Full red blood cell turnover",
    },
  ];
          ...
          <div>
            ...
            >
              ...
              <div
                style={{
                  background:
                    "linear-gradient(135deg, #ef444420 0%, #0f172a 100%)",
                  borderRadius: "16px",
                  padding: "20px",
              ...
              >
                ...
                <div
                  style={{ color: "#22c55e", fontWeight: 800, fontSize: "1.6rem" }}
                >
                  117/79
                </div>
                <div
              ...
              <div
                style={{
                  background:
                    "linear-gradient(135deg, #f9731620 0%, #0f172a 100%)",
                  borderRadius: "16px",
                  padding: "20px",
              ...
              >
                ...
                <div
                  style={{ color: "#fb923c", fontWeight: 800, fontSize: "1.6rem" }}
                >
                  79 bpm
                </div>
                <div
              ...
              <div
                style={{
                  background:
                    "linear-gradient(135deg, #3b82f620 0%, #0f172a 100%)",
                  borderRadius: "16px",
                  padding: "20px",
              ...
              >
                ...
                <div
                  style={{ color: "#60a5fa", fontWeight: 800, fontSize: "1.6rem" }}
                >
                  7.0-7.5%
                </div>
                <div
            ...
            >
              <h3
                style={{ color: "#fff", margin: "0 0 15px 0", fontSize: "1.1rem" }}
              >
        ...
        {activeTab === "bp" && (
          <div>
            ...
            >
              ...
              <div
                style={{ color: "#bbf7d0", fontSize: "1.1rem", marginTop: "5px" }}
              >
                HR: 79 bpm
              </div>
              <div
            ...
            >
              ...
              >
                <div style={{ textAlign: "center" }}>
                  ...
                  <div
                    style={{ color: "#fb923c", fontWeight: 800, fontSize: "1.5rem" }}
                  >
                    130/84
                  </div>
                ...
                <div style={{ textAlign: "center" }}>
                  ...
                  <div
                    style={{ color: "#4ade80", fontWeight: 800, fontSize: "1.5rem" }}
                  >
                    117/79
                  </div>
              ...
              >
                <span style={{ color: "#94a3b8", fontSize: "0.85rem" }}>
                  ...
                  • Diastolic:{" "}
                  <strong style={{ color: "#22c55e" }}>-5 mmHg</strong>
                </span>
              </div>
            </div>
        ...
        {activeTab === "a1c" && (
          <div>
            ...
            >
              ...
              <div
                style={{ color: "#93c5fd", fontSize: "1rem", marginTop: "5px" }}
              >
            ...
            >
              ...
              >
                <div
                  style={{
                    ...
                    background:
                      "linear-gradient(90deg, #ef4444 0%, #f97316 30%, #fbbf24 60%, #22c55e 100%)",
                    borderRadius: "12px",
              ...
              >
                Predicted:{" "}
                <strong style={{ color: "#fbbf24" }}>7.25%</strong> (midpoint
                estimate)
              </div>
            </div>
        ...
        {activeTab === "protocol" && (
          <div>
            ...
            >
              ...
              <h2
                style={{ color: "#fff", margin: "0 0 20px 0", fontSize: "1.3rem" }}
              >
